...
mod tests {
    ...
    #[test]
    fn test_linux_secret_memory_mut_allocation() {
        let secret_mem =
    ...
    #[test]
    fn test_linux_secret_memory_mut_write_and_read() {
        let mut secret_mem =
            LinuxSecretMemoryMut::with_length(1024).expect("Failed to allocate memory");
    ...
    #[test]
    fn test_linux_secret_memory_conversion() {
        let secret_mem_mut =
            LinuxSecretMemoryMut::with_length(1024).expect("Failed to allocate memory");
    ...
    #[test]
    fn test_linux_secret_memory_read_only_protection() {
